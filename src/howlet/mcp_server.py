...
Run with `howlet mcp` (stdio transport). Any MCP-capable client -
...
Claude Code setup:
    claude mcp add howlet -e EDGAR_USER_AGENT="Jane Doe jane@example.com" \
        -- howlet mcp
...
Requires the optional dependency: pip install "howlet[mcp]"
"""
