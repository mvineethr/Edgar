"""Bloomberg-terminal-style web dashboard for Howlet.
...
`howlet mcp` AI tool server); this module is just Flask wiring.
...
Run via `howlet dashboard` or:
    from howlet.dashboard import run_dashboard
